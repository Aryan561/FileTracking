<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="FMATS.ResetPassword" %>
...
<head>
    ...
    <title> File Tracking  | ResetPassword</title>
        ...
        <div class="col-sm-offset-3 col-sm-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form id="ResetPasswordform" method="post" runat="server" class="form-horizontal bv-form" novalidate="novalidate">
                        <p class="text-danger">
                        ...
                        <%-- <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="password" class="form-control" name="txtOldPassword" id="txtOldPassword" placeholder="Enter Old Password" data-bv-field="txtOldPassword">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <asp:Button ID="btn_register" runat="server" CssClass="btn btn-primary" Text="Reset" OnClick="btn_register_Click" />
